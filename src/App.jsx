...
function App() {
  ...
  const translations = {
    ...
    en: {
      ...
      blog: 'Blog',
      contact: 'Contact',
      fullStackDeveloper: 'Computer Engineer',
      heroDescription: "Hi, I'm Ikbal. I write code, develop ideas, and bring life to projects. Flutter, Python, C#... they're all just tools—the actual repository. I love building things from scratch.",
      years: 'Years',
      ...
      ecommercePlatform: 'Market Prices',
      mobileApp: 'CodeMania',
      dashboardSystem: 'Petfix',
      ...
      letsGrabCoffee: "Let's have a coffee and find answers to your questions.",
      yourName: 'Muhammet İkbal Sağdıç',
      yourEmail: 'muhammet.ikbal.sagdic@gmail.com',
